...
public class EnrollmentControllerTest {
    ...
    private ArrayList<CourseOffering> requestedOfferings(Course... courses) {
        Calendar cal = Calendar.getInstance();
        ArrayList<CourseOffering> result = new ArrayList<>();
        for (Course course : courses) {
            cal.add(Calendar.DATE, 1);
            result.add(new CourseOffering(course, cal.getTime()));
        }
        return result;
    }
    ...
    private boolean hasTaken(Student s, Course... courses) {
        ...
        for (TakenCourse cs : s.getCurrentTerm().getTakenCourses())
    ...
    public void canTakeBasicCoursesInFirstTerm() throws EnrollmentRulesViolationException {
        new EnrollmentController().enroll(bebe, requestedOfferings(math1, phys1, prog));
        assertTrue(hasTaken(bebe, math1, phys1, prog));
    }

    @Test
    public void canTakeNoOfferings() throws EnrollmentRulesViolationException {
        new EnrollmentController().enroll(bebe, new ArrayList<>());
    ...
    public void cannotTakeWithoutPreTaken() throws EnrollmentRulesViolationException {
        new EnrollmentController().enroll(bebe, requestedOfferings(math2, phys1, prog));
    }
    ...
    public void cannotTakeWithoutPrePassed() throws EnrollmentRulesViolationException {
        ...
        new EnrollmentController().enroll(bebe, requestedOfferings(math2, ap));
    }
    ...
    public void canTakeWithPreFinallyPassed() throws EnrollmentRulesViolationException {
        ...
        new EnrollmentController().enroll(bebe, requestedOfferings(math2, dm));
    ...
    public void cannotTakeAlreadyPassed1() throws EnrollmentRulesViolationException {
        ...
        new EnrollmentController().enroll(bebe, requestedOfferings(math1, dm));
    }
    ...
    public void cannotTakeAlreadyPassed2() throws EnrollmentRulesViolationException {
        ...
        new EnrollmentController().enroll(bebe, requestedOfferings(phys1, dm));
    }

    @Test(expected = EnrollmentRulesViolationException.class)
    public void cannotTakeOfferingsWithSameExamTime() throws EnrollmentRulesViolationException {
        Calendar cal = Calendar.getInstance();
        new EnrollmentController().enroll(bebe,
                List.of(
                        new CourseOffering(phys1, cal.getTime()),
                        new CourseOffering(math1, cal.getTime()),
                        new CourseOffering(phys1, cal.getTime())
                ));
    }
    ...
    public void cannotTakeACourseTwice() throws EnrollmentRulesViolationException {
        new EnrollmentController().enroll(bebe, requestedOfferings(phys1, dm, phys1));
    }
    ...
    public void canTake14WithGPA11() throws EnrollmentRulesViolationException {
        ...
        new EnrollmentController().enroll(bebe, requestedOfferings(dm, math1, farsi, akhlagh, english, maaref));
    ...
    public void cannotTake15WithGPA11() throws EnrollmentRulesViolationException {
        ...
        new EnrollmentController().enroll(bebe, requestedOfferings(dm, math1, farsi, akhlagh, english, ap));
    ...
    public void canTake15WithGPA15() throws EnrollmentRulesViolationException {
        ...
        new EnrollmentController().enroll(bebe, requestedOfferings(dm, math2, farsi, akhlagh, english, maaref));
    ...
    public void cannotTake18WithGPA15() throws EnrollmentRulesViolationException {
        ...
        new EnrollmentController().enroll(bebe, requestedOfferings(ap, dm, math2, farsi, akhlagh, english, ap));
    ...
    public void canTake20WithGPA16() throws EnrollmentRulesViolationException {
        ...
        new EnrollmentController().enroll(bebe, requestedOfferings(
